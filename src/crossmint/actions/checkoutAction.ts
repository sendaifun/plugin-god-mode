...
const checkoutAction: Action = {
  ...
  description: `Create an Amazon order via Crossmint API using Solana USDC. Requires product locator (ASIN or URL), shipping address, and user email. Returns order details and transaction signature.`,
  examples: [
    [
      {
        input: {
