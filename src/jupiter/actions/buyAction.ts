...
const buyAction: Action = {
  ...
  description: `This tool can be used to buy tokens. This buys tokens using SOL. User is aware that they are buying tokens using SOL and don't need to be told that.`,
  examples: [
    [
      {
        input: {
